...
def unnormalize(tensor, mean=[0.7720342, 0.74582646, 0.76392896], std=[0.24745085, 0.26182273, 0.25782376], inplace: bool = False):
...
def input_images(x, y, i, n_iter, k=1):
    ...
    if k == 1:
        ...
        x3 = x2[1, :, :, :].transpose((1, 2, 0)).astype('uint8')
        y3 = y2[1, 0, :, :]
